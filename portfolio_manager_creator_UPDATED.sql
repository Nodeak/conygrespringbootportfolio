...
-- Dumping data for table portfolio_manager.holdings: ~6 rows (approximately)
/*!40000 ALTER TABLE `holdings` DISABLE KEYS */;
REPLACE INTO `holdings` (`id`, `account_id`, `type`, `name`, `symbol`, `buy_price`, `amount`) VALUES
	(1, 1, 'Stock', 'Citi', 'C', 76.11, 1),
	(2, 1, 'Stock', 'Tesla', 'TSLA', 211.31, 1),
	(3, 3, 'Stock', 'Apple', 'AAPL', 148.42, 100),
	(4, 3, 'Stock', 'Google', 'GOOG', 1232, 57),
	(5, 1, 'Stock', 'Citi', 'C', 76.11, 1),
	(6, 3, 'Stock', 'Amazon', 'AMZN', 3100, 3);
